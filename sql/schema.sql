...
create table Acteur (
	id               number(8) PRIMARY KEY,
	professionnel_id number(8) NOT NULL REFERENCES Professionnel (id)
);
...
create table Serie (
	noVideo                   number(6) NOT NULL, -- vidéo de la série
	noOeuvreCinematographique number(6) NOT NULL, -- oeuvre
	CONSTRAINT genreDomaineSe CONSTRAINT fkSerie
	CONSTRAINT numeroDomaineSe
	CHECK (numero>=0)
);

create table OeuvreCinematographique(
	noOeuvreCinematographique number(6) PRIMARY KEY,
	noVideo                   number(6) REFERENCES Video (noVideo),
	numero                    number(2), -- numéro dans la série
	noVideoSerie              number(6), REFERENCES Serie (noVideo) -- série
	CONSTRAINT numeroDomaineOC CHECK (numero>=0)
);

create table Emission(
	noEmission                number(6) PRIMARY KEY,
	noOeuvreCinematographique number(6),
	CONSTRAINT fkEmission FOREIGN KEY (noOeuvreCinematographique) REFERENCES OeuvreCinematographique (noOeuvreCinematographique),
	CONSTRAINT numeroDomaineEm CHECK (numero>=0)
);

create table Film(
	noFilm                    number(6) PRIMARY KEY,
	noOeuvreCinematographique number(6),
	CONSTRAINT pkFilm
...
create table BandeAnnonce(
	noBandeAnnonce number(6) PRIMARY KEY,
	noVideo        number(6),
	noOeuvreCin    number(6), -- oeuvre cinématographique associée
...
create table Fichier (
	...
	CHECK (prix>=0), CONSTRAINT estArchiveBool
	CHECK (estArchive in (0,1)), CONSTRAINT nbTelechargementPositif
	CHECK (nbTelechargement>=0), CONSTRAINT nbVisionnementPositif
	CHECK (nbVisionnement>=0)
);

create table Compte (
	nomUtilisateur  varchar2(55),
...
create table Loue (
	...
	chemin         varchar2(50),
	-- todo: utiliser un datetime pour la date et l'heure
	dateLocation   date,
	heureLocation  varchar2(5),
	prix           decimal(5,2) NOT NULL,
	CONSTRAINT pkLoue
	PRIMARY KEY (nomUtilisateur, chemin, dateLocation, heureLocation),
	CONSTRAINT fk1Loue FOREIGN KEY (nomUtilisateur) REFERENCES
...
insert into Cinema values (00010, 'Ciné-Club de Laval', '475 boulevard de lAvenir H7N5H9', 4506672040, 'cineclublaval@gmail.com');
...
insert into Personne values(10000003, 'Emilios', 'Tostitos', 'homme', to_date('12/06/92', 'DD/MM/YY'), null);
insert into Personne values(10000004, 'Maxime', 'Karoui', 'inconnu', to_date('13/12/90', 'DD/MM/YY'), null);
insert into Personne values(10000005, 'Simon', 'Corleone', 'homme', to_date('06/04/84', 'DD/MM/YY'), null);
insert into Personne values(10000006, 'Claire', 'Underwolfe', 'femme', to_date('24/07/66', 'DD/MM/YY'), null);
insert into Personne values(10000007, 'François', 'Smith', 'cache', to_date('12/11/01', 'DD/MM/YY'), null);
insert into Personne values(10000008, 'Bob', 'Poitras', 'inconnu', to_date('28/09/85', 'DD/MM/YY'), null);
insert into Personne values(10000009, 'Annabelle', 'Poirier', 'femme', to_date('03/06/89', 'DD/MM/YY'), null);
insert into Personne values(10000010, 'Isabelle', 'St-Louis', 'femme', to_date('12/12/11', 'DD/MM/YY'), null);
insert into Personne values(10000011, 'Madeleine', 'Antaki', 'femme', to_date('22/04/85', 'DD/MM/YY'), null);
insert into Personne values(10000012, 'Jacques', 'Charest', 'homme', to_date('12/08/93', 'DD/MM/YY'), null);
insert into Personne values(10000013, 'David', 'Khadir', 'homme', to_date('08/07/85', 'DD/MM/YY'), null);
insert into Personne values(10000014, 'Goliath', 'Couillard', 'homme', to_date('06/04/73', 'DD/MM/YY'), null);
...
insert into Realisateur values(20000021, 'George', 'Clooney', 'homme', to_date('06/05/61', 'DD/MM/YY'), null, 'Acteur, producteur, scénariste et réalisateur, George Timothy Clooney est né le 6 mai 1961 à Lexington, au Kentucky. Star planétaire révélée par la série Urgences, il est un collaborateur privilégié de Steven Soderbergh (la trilogie Ocean, Hors d''ateinte, Solaris, The good german) et des frères Coen (O''Brother, Intolérable cruauté, Burn After Reading) mais est aussi célèbre pour ses rôles dans les films Les rois du désert, The Descendants et Gravity. Côté réalisation, on lui doit les films Confession d''un homme dangereux, Good night and good luck, Jeux de dupes, Les marches du pouvoir et The Monuments Men. La classe, l''allure, l''élégance, le charme, l''humour, le goût, l''intelligence et un certain bon sens moral et politique, voilà ce qui pourrait définir l''un des plus grands sex symbols d''Hollywood depuis le milieu des années 90 : George Clooney. Depuis la série Urgences où il fût révélé au grand public, il est devenu une star, du gros calibre, de ceux qu''on écoute, qu''on regarde et qu''on respecte, avec qui on est ami. Lui par contre n''en fait qu''à sa tête. Et s''il a bien commis quelques erreurs de parcours en sortant de ses barreaux cathodiques, depuis il fait ce que bon lui semble. Il travaille pour les projets qu''il aime ou pour ses amis, les cinéastes dont il se sent proche, quand il ne réalise par lui-même ses films ou alerte par le biais de l''ONU du génocide au Darfour.');

insert into Serie values(300001, 'Après une apocalypse ayant transformé la quasi-totalité de la population en zombies, un groupe d''hommes et de femmes mené par l''officier Rick Grimes tente de survivre... Ensemble, ils vont devoir tant bien que mal faire face à ce nouveau monde devenu méconnaissable, à travers leur périple dans le Sud profond des États-Unis.', 'The Walking Dead', to_date('01/10/10', 'DD/MM/YY'), 'Épouvante', null, null);
insert into Serie values(300002, 'Saison 1 de la populaire émission The Walking Dead', 'The Walking Dead: saison 1', to_date('01/09/10', 'DD/MM/YY'), 'Épouvante', 1, 300001);
insert into Serie values(300003, 'Saison 2 de la populaire émission The Walking Dead', 'The Walking Dead: saison 2', to_date('01/09/11', 'DD/MM/YY'), 'Épouvante', 2, 300001);
insert into Serie values(300004, 'Saison 3 de la populaire émission The Walking Dead', 'The Walking Dead: saison 3', to_date('01/09/12', 'DD/MM/YY'), 'Épouvante', 3, 300001);
insert into Serie values(300005, 'Saison 4 de la populaire émission The Walking Dead', 'The Walking Dead: saison 4', to_date('01/09/13', 'DD/MM/YY'), 'Épouvante', 4, 300001);
insert into Serie values(300006, 'Saison 5 de la populaire émission The Walking Dead', 'The Walking Dead: saison 5', to_date('01/09/14', 'DD/MM/YY'), 'Épouvante', 5, 300001);
insert into Serie values(300007, 'Il y a très longtemps, à une époque oubliée, une force a détruit l''équilibre des saisons. Dans un pays où l''été peut durer plusieurs années et l''hiver toute une vie, des forces sinistres et surnaturelles se pressent aux portes du Royaume des Sept Couronnes. La confrérie de la Garde de Nuit, protégeant le Royaume de toute créature pouvant provenir d''au-delà du Mur protecteur, n''a plus les ressources nécessaires pour assurer la sécurité de tous. Après un été de dix années, un hiver rigoureux s''abat sur le Royaume avec la promesse d''un avenir des plus sombres. Pendant ce temps, complots et rivalités se jouent sur le continent pour s''emparer du Trône de Fer, le symbole du pouvoir absolu.', 'Games of Thrones', to_date('17/05/11', 'DD/MM/YY'), 'Fantastique', null, null);
insert into Serie values(300008, 'Saison 1 de la populaire émission Game of Thrones', 'Game of Thrones: saison 1', to_date('17/04/11', 'DD/MM/YY'), 'Fantastique', 1, 300007);
insert into Serie values(300012, 'Saison 2 de la populaire émission Game of Thrones', 'Game of Thrones: saison 2', to_date('17/04/12', 'DD/MM/YY'), 'Fantastique', 2, 300007);
insert into Serie values(300009, 'Cela fait des années qu’ils ne se sont pas vus lorsque Martin, un loser qui multiplie les mauvaises fréquentations et accumule les problèmes, débarque chez son frère, Jean, un Frenchy installé à Londres où il mène une vie bien rangée de chef d’entreprise, de mari, de père de famille… et d''amant discret. Martin n’est pas le bienvenu. Jean a tiré un trait sur son passé. Mais le métier de Jean, nettoyeur de scènes de crimes, et le don de Martin d''attirer les embrouilles vont très vite les propulser dans l’univers à la fois sordide et délirant du crime organisé. Et ils vont devoir affronter leurs traumatismes et comprendre que rien ou presque ne pourra véritablement effacer le terrible secret qui remonte à leur enfance, dans leur Vendée natale, au cœur de la ferme familiale.', 'Spotless', to_date('04/10/15', 'DD/MM/YY'), 'Thriller', null, null);
insert into Serie values(300010, 'Après une apocalypse nucléaire causée par l''Homme lors d''une troisième Guerre Mondiale, les 318 survivants recensés se réfugient dans des stations spatiales et parviennent à y vivre et à se reproduire, atteignant le nombre de 4000. Mais 97 ans plus tard, le vaisseau mère, l''Arche, est en piteux état. Une centaine de jeunes délinquants emprisonnés au fil des années pour des crimes ou des trahisons sont choisis comme cobayes par les autorités pour redescendre sur Terre et tester les chances de survie. Dès leur arrivée, ils découvrent un nouveau monde dangereux mais fascinant...', 'The 100', to_date('02/05/14', 'DD/MM/YY'), 'Science fiction', null, null);
insert into Serie values(300011, 'Very Bad Trip (The Hangover) est une série de films américains réalisés par Todd Phillips, qui a débutée en 2009 et se termina en 2013.', 'Very bad trip', to_date('24/06/09', 'DD/MM/YY'), 'Comédie', null, null);

---insert into Emission values(300012, 'description', 'titre', todate Sortie, 'genre', 12 numero dans la serie, 123456 num de la serie);
insert into Emission values(300020, 'Dans le Kentucky, Rick Grimes, un policier, se réveille à l''hôpital après plusieurs semaines de coma provoqué par une fusillade qui a mal tourné. Il découvre que le monde, ravagé par une épidémie, est envahi par les morts-vivants. Rick ne songe qu''à une chose : retrouver sa femme Lori et son fils Carl. Il se rend chez lui mais constate qu''ils ont disparu, puis rencontre Morgan et son fils Duane, qui se terrent dans leur maison. L''homme lui explique que la seule façon de tuer les zombies est de les atteindre à la tête. Il lui indique aussi qu''il existe un camp de réfugiés aux alentours d''Atlanta...', 'Passé décomposé', to_date('01/10/10', 'DD/MM/YY'), 'Épouvante', 1, 300002);
insert into Emission values(300021, 'Rick parvient à s''extraire du char et rencontre un groupe de survivants avec le jeune Glenn, Andrea, Morales, T-Dog et Merle Dixon, un homme passablement raciste et énervé. Tous sont réfugiés dans un immeuble et se demandent comment en sortir. Les zombies tentent de prendre d''assaut le bâtiment. Rick est obligé d''attacher Dixon pour le calmer car son attitude envers T-Dog envenime la situation. Le petit groupe pense d''abord à s''échapper par les égouts. Dans le camp de réfugiés à l''extérieur de la ville, Lori et Shane deviennent amants...', 'Tripes', to_date('07/11/10', 'DD/MM/YY'), 'Épouvante', 2, 300002);
insert into Emission values(300022, 'Rick, Glenn et le petit groupe de survivants parviennent à rejoindre le camp de réfugiés situé dans les montagnes aux alentours d''Atlanta. Rick retrouve sa femme Lori et son fils Carl. Son ancien coéquipier, Shane, qui était devenu l''amant de Lori, est forcément surpris du retour de Rick. Le cas de Merle Dixon fait débat : fallait-il le laisser attaché sur le toit sans défense ? La découverte d''un mort-vivant aux abords du camp et le retour de Daryl Dixon, le frère de Merle, précipitent les choses : Rick décide de retourner à Atlanta pour délivrer Merle et récupérer des armes et des munitions...', 'Les grenouilles', to_date('14/11/10', 'DD/MM/YY'), 'Épouvante', 3, 300002);
insert into Emission values(300023, 'A Atlanta, Rick, Glenn, T-Dog et Daryl cherchent Merle, qui a réussi à s''enfuir malgré sa main coupée. En voulant récupérer le sac d''armes, ils rencontrent un autre groupe de survivants, qui eux aussi veulent s''emparer des munitions. Le gang capture Glenn et les deux parties vont devoir négocier. Au camp en dehors de la ville, alors qu''Andrea s''est rapprochée de sa soeur Amy, Jim montre des signes d''inquiétude. L''homme ne cesse de creuser des tombes et semble perdre toute notion de la réalité. Les autres habitants du camp décident de l''attacher de manière préventive...', 'Le gang', to_date('21/11/10', 'DD/MM/YY'), 'Épouvante', 4, 300002);
insert into Emission values(300024, 'Après l''attaque du campement, tous les survivants sont résignés et abattus. Andrea pleure sa soeur Amy, Shane reproche à Rick d''être parti à Atlanta et d''avoir laissé le camp sans renfort, mais c''est surtout l''état de santé de Jim qui inquiète. Il a été mordu par un mort-vivant et sa santé se dégrade. Rick cherche du soutien chez Lori et propose au groupe de quitter les montagnes pour essayer de trouver le centre de soins et de prévention des maladies infectieuses. Il pense que l''endroit est encore protégé par l''armée. Tous prennent la route alors que Jim est de plus en plus fiévreux...', 'Wildfire', to_date('28/11/10', 'DD/MM/YY'), 'Épouvante', 5, 300002);
insert into Emission values(300025, 'Rick et les survivants pénètrent dans le centre de soins et de recherche sur les maladies infectieuses. Là, le docteur Edwin Jenner les accueille. Il est le seul scientifique présent et vit seul depuis plusieurs mois. Après avoir profité d''un repos auquel ils n''avaient plus goûté depuis longtemps, Rick, Shane et le groupe se posent beaucoup de questions sur ce qui s''est passé dans le centre. Le docteur Jenner leur explique l''état le plus avancé de la recherche sur ce qui transforme les morts en zombies. Mais la situation n''est pas aussi idéale qu''il n''y paraît...', 'Sujet-test 19', to_date('05/12/10', 'DD/MM/YY'), 'Épouvante', 6, 300002);
insert into Emission values(300026, 'Les survivants se retrouvent bloqués sur une route envahie par des carcasses de voitures. Ils décident d''en profiter pour siphonner les réservoirs. C''est alors qu''ils sont surpris par un groupe de zombies. Dale tente de superviser les opérations du haut du camion, tandis que Sophia, imprudente, est poursuivie par un groupe de zombies tenaces. Rick parvient à tuer les créatures qui menaçaient Sophia mais la jeune fille disparaît. Rick et les autres se lancent à sa poursuite...', 'Ce qui nous attend', to_date('16/10/11', 'DD/MM/YY'), 'Épouvante', 1, 300003);
insert into Emission values(300027, 'A Port-Réal, Tyrion Lannister connaît bien les codes de la Cour royale et use de toute son intelligence pour étendre son influence. Modéré et stratège, il veut limiter les accès de cruauté du roi Joffrey, parfois imprévisible. De son côté, Catelyn Stark s''emploie à négocier une paix entre Stannis et Renly Baratheon, indispensable dans le conflit qui oppose les Stark aux Lannister. Toujours sur la route avec ses quelques fidèles, Daenerys Targaryen arrive à la grande cité de Qarth et espère y trouver refuge...', 'La Cité de Qarth', to_date('22/04/12', 'DD/MM/YY'), 'Fantastique', 4, 300003);

---insert into Film values(123456, 'description', 'titre', todate Sortie, 'genre', 12 numero dans la serie, 123456 num de la serie);
insert into Film values(310000, 'Au réveil d''un enterrement de vie de garçon bien arrosé, les trois amis du fiancé se rendent compte qu''il a disparu 40 heures avant la cérémonie de mariage. Ils vont alors devoir faire fi de leur gueule de bois et rassembler leurs bribes de souvenirs pour comprendre ce qui s''est passé.', 'Very bad trip 1', to_date('24/06/09', 'DD/MM/YY'), 'Comédie', 1, 300011);
insert into Film values(310001, 'Phil, Stu, Alan et Doug s’offrent un voyage exotique en Thaïlande, à l’occasion du mariage de Stu. Après l’inoubliable soirée d’enterrement de sa vie de garçon à Las Vegas, Stu ne veut rien laisser au hasard et opte pour un brunch léger, sans risque, avant la cérémonie. Mais les choses ne se passent pas toujours comme prévu. Ce qui s''est passé à Las Vegas est imaginable à Las Vegas, mais ce qui se passe à Bangkok dépasse l’imagination...', 'Very bad trip 2', to_date('25/05/11', 'DD/MM/YY'), 'Comédie', 2, 300011);
insert into Film values(310002, 'Deux ans ont passé. Phil (Bradley Cooper), Stu (Ed Helms) et Doug (Justin Bartha) mènent des existences tranquilles et heureuses. Ils ont fait disparaître leurs tatouages et se sont rachetés une conduite. Aux dernières nouvelles, Leslie Chow (Ken Jeong), qui attirait les catastrophes, a échoué dans une prison en Thaïlande : depuis qu''il n''est plus dans le secteur, nos trois lascars ont - presque - oublié leurs folles virées nocturnes à travers les quartiers sordides de Las Vegas, à moitié shootés, et le jour où ils se sont fait kidnapper, tirer dessus et prendre en chasse par une bande de dangereux dealers à Bangkok... Le seul de la Meute à ne pas avoir trouvé son équilibre est Alan (Zach Galifianakis). Se cherchant toujours, la brebis galeuse du groupe a arrêté les médocs et donné libre cours à ses impulsions, ce qui, dans son cas, revient à ne reculer devant rien et à ne se fixer aucune limite... Jusqu''à ce qu''il traverse une crise douloureuse et qu''il se mette en quête du soutien dont il a besoin. Et qui mieux que ses trois meilleurs copains pourraient l''aider à s''engager dans la bonne voie ? Cette fois, il n''y a pas de mariage, ni de fête d''enterrement de vie de garçon. Qu''est-ce-qui pourrait donc bien dégénérer ? Mais quand la Meute s''en mêle, il faut être prêt à tout ! Et pour boucler la boucle, la petite bande doit retourner là où tout a commencé : à Las Vegas...', 'Very bad trip 3', to_date('29/05/13', 'DD/MM/YY'), 'Comédie', 3, 300011);
insert into Film values(310003, 'Dans le sud des États-Unis, deux ans avant la guerre de Sécession, le Dr King Schultz, un chasseur de primes allemand, fait l’acquisition de Django, un esclave qui peut l’aider à traquer les frères Brittle, les meurtriers qu’il recherche. Schultz promet à Django de lui rendre sa liberté lorsqu’il aura capturé les Brittle – morts ou vifs. Alors que les deux hommes pistent les dangereux criminels, Django n’oublie pas que son seul but est de retrouver Broomhilda, sa femme, dont il fut séparé à cause du commerce des esclaves…
Lorsque Django et Schultz arrivent dans l’immense plantation du puissant Calvin Candie, ils éveillent les soupçons de Stephen, un esclave qui sert Candie et a toute sa confiance. Le moindre de leurs mouvements est désormais épié par une dangereuse organisation de plus en plus proche… Si Django et Schultz veulent espérer s’enfuir avec Broomhilda, ils vont devoir choisir entre l’indépendance et la solidarité, entre le sacrifice et la survie…', 'Django Unchained', to_date('16/01/13', 'DD/MM/YY'), 'Western', null, null);
insert into Film values(310004, 'Quelques décennies d''histoire américaine, des années 1940 à la fin du XXème siècle, à travers le regard et l''étrange odyssée d''un homme simple et pur, Forrest Gump.', 'Forrest Gump', to_date('05/10/94', 'DD/MM/YY'), 'Comédie', null, null);
insert into Film values(310005, 'Paul Edgecomb, pensionnaire centenaire d''une maison de retraite, est hanté par ses souvenirs. Gardien-chef du pénitencier de Cold Mountain en 1935, il était chargé de veiller au bon déroulement des exécutions capitales en s’efforçant d''adoucir les derniers moments des condamnés. Parmi eux se trouvait un colosse du nom de John Coffey, accusé du viol et du meurtre de deux fillettes. Intrigué par cet homme candide et timide aux dons magiques, Edgecomb va tisser avec lui des liens très forts.', 'La ligne verte', to_date('01/03/00', 'DD/MM/YY'), 'Policier', null, null);
insert into Film values(310006, 'Walt Kowalski est un ancien de la guerre de Corée, un homme inflexible, amer et pétri de préjugés surannés. Après des années de travail à la chaîne, il vit replié sur lui-même, occupant ses journées à bricoler, traînasser et siroter des bières. Avant de mourir, sa femme exprima le voeu qu''il aille à confesse, mais Walt n''a rien à avouer, ni personne à qui parler. Hormis sa chienne Daisy, il ne fait confiance qu''à son M-1, toujours propre, toujours prêt à l''usage... Ses anciens voisins ont déménagé ou sont morts depuis longtemps. Son quartier est aujourd''hui peuplé d''immigrants asiatiques qu''il méprise, et Walt ressasse ses haines, innombrables - à l''encontre de ses voisins, des ados Hmong, latinos et afro-américains "qui croient faire la loi", de ses propres enfants, devenus pour lui des étrangers. Walt tue le temps comme il peut, en attendant le grand départ, jusqu''au jour où un ado Hmong du quartier tente de lui voler sa précieuse Ford Gran Torino... Walt tient comme à la prunelle de ses yeux à cette voiture fétiche, aussi belle que le jour où il la vit sortir de la chaîne. Lorsque le jeune et timide Thao tente de la lui voler sous la pression d''un gang, Walt fait face à la bande, et devient malgré lui le héros du quartier. Sue, la soeur aînée de Thao, insiste pour que ce dernier se rachète en travaillant pour Walt. Surmontant ses réticences, ce dernier confie au garçon des "travaux d''intérêt général" au profit du voisinage. C''est le début d''une amitié inattendue, qui changera le cours de leur vie. Grâce à Thao et sa gentille famille, Walt va découvrir le vrai visage de ses voisins et comprendre ce qui le lie à ces exilés, contraints de fuir la violence... comme lui, qui croyait fermer la porte sur ses souvenirs aussi aisément qu''il enfermait au garage sa précieuse Gran Torino...', 'Gran Torino', to_date('25/02/09', 'DD/MM/YY'), 'Thriller', null, null);
insert into Film values(310007, 'Dans ce nouveau volet, Batman augmente les mises dans sa guerre contre le crime. Avec l''appui du lieutenant de police Jim Gordon et du procureur de Gotham, Harvey Dent, Batman vise à éradiquer le crime organisé qui pullule dans la ville. Leur association est très efficace mais elle sera bientôt bouleversée par le chaos déclenché par un criminel extraordinaire que les citoyens de Gotham connaissent sous le nom de Joker.', 'Le Chevalier Noir', to_date('13/08/08', 'DD/MM/YY'), 'Thriller', null, null);
insert into Film values(310008, 'Evocation des années de guerre d''Oskar Schindler, fils d''industriel d''origine autrichienne rentré à Cracovie en 1939 avec les troupes allemandes. Il va, tout au long de la guerre, protéger des juifs en les faisant travailler dans sa fabrique et en 1944 sauver huit cents hommes et trois cents femmes du camp d''extermination de Auschwitz-Birkenau.', 'La Liste de Schindler', to_date('02/03/94', 'DD/MM/YY'), 'Historique', null, null);
insert into Film values(310009, 'Une veuve mono-parentale hérite de la garde de son fils, un adolescent TDAH impulsif et violent. Au coeur de leurs emportements et difficultés, ils tentent de joindre les deux bouts, notamment grâce à l’aide inattendue de l’énigmatique voisine d’en face, Kyla. Tous les trois, ils retrouvent une forme d’équilibre et, bientôt, d’espoir.', 'Mommy', to_date('08/10/14', 'DD/MM/YY'), 'Drame', null, null);
insert into Film values(310010, 'A la suite d’un accident de parapente, Philippe, riche aristocrate, engage comme aide à domicile Driss, un jeune de banlieue tout juste sorti de prison. Bref la personne la moins adaptée pour le job. Ensemble ils vont faire cohabiter Vivaldi et Earth Wind and Fire, le verbe et la vanne, les costumes et les bas de survêtement... Deux univers vont se télescoper, s’apprivoiser, pour donner naissance à une amitié aussi dingue, drôle et forte qu’inattendue, une relation unique qui fera des étincelles et qui les rendra... Intouchables.', 'Intouchables', to_date('02/11/11', 'DD/MM/YY'), 'Comédie', null, null);

---insert into BandeAnnonce values(123456, 'description', 'titre', dateSortie, 'genre', 123456 videorefere);
insert into BandeAnnonce values(400000, 'Ceci est la bande-annonce officielle de la 1re saison de The Walking Dead', 'Bande-Annonce Intégrale - Walking Dead saison 1', to_date('01/09/10', 'DD/MM/YY'), 'Épouvante', 300002);
insert into BandeAnnonce values(400001, 'Ceci est la bande-annonce officielle de la 2e saison de The Walking Dead', 'Bande-Annonce Intégrale - Walking Dead saison 2', to_date('01/09/11', 'DD/MM/YY'), 'Épouvante', 300003);
insert into BandeAnnonce values(400002, 'Ceci est la bande-annonce officielle de la 3e saison de The Walking Dead', 'Bande-Annonce Intégrale - Walking Dead saison 3', to_date('01/09/12', 'DD/MM/YY'), 'Épouvante', 300004);
insert into BandeAnnonce values(400003, 'Ceci est la bande-annonce officielle de la 4e saison de The Walking Dead', 'Bande-Annonce Intégrale - Walking Dead saison 4', to_date('01/09/13', 'DD/MM/YY'), 'Épouvante', 300005);
insert into BandeAnnonce values(400004, 'Ceci est la bande-annonce officielle de la 5e saison de The Walking Dead', 'Bande-Annonce Intégrale - Walking Dead saison 5', to_date('01/09/14', 'DD/MM/YY'), 'Épouvante', 300006);
insert into BandeAnnonce values(400005, 'Ceci est la 2e bande-annonce de la 1re saison de The Walking Dead', 'Bande-Annonce #2 - The Walking Dead saison 1', to_date('20/02/14', 'DD/MM/YY'), 'Épouvante', 300002);
insert into BandeAnnonce values(400006, 'Ceci est la bande-annonce officielle du film Intouchables', 'Bande-Annonce Intégrale - Intouchables', to_date('02/01/11', 'DD/MM/YY'), 'Comédie', 310010);
insert into BandeAnnonce values(400007, 'Ceci est la bande-annonce officielle du film Le chevalier noir', 'Bande-Annonce Intégrale - Le chevalier noir', to_date('13/03/08', 'DD/MM/YY'), 'Épouvante', 300007);
insert into BandeAnnonce values(400008, 'Ceci est la bande-annonce officielle du film Mommy', 'Bande-Annonce - Mommy de Xavier Dolan', to_date('08/01/14', 'DD/MM/YY'), 'Épouvante', 300009);
insert into BandeAnnonce values(400009, 'Ceci est la bande-annonce officielle du 1er épisode ("Passé Décomposé") de la 1re saison de The Walking Dead', 'Bande-Annonce - Walking Dead saison 1 épisode 1', to_date('01/01/10', 'DD/MM/YY'), 'Épouvante', 300020);
...
insert into Article values(0000001, to_date('19/02/14', 'DD/MM/YY'), 'Le Chevalier Noir est un bon film, tout comme Forrest Gump', 93);
insert into Article values(0000002, to_date('11/12/09', 'DD/MM/YY'), 'J''ai adoré la série The Walking Dead au complet', 89);
insert into Article values(0000003, to_date('02/10/09', 'DD/MM/YY'), 'Game of Thrones: Quelle mauvaise série!', 26);
insert into Article values(0000004, to_date('15/06/10', 'DD/MM/YY'), 'Très ému par le film Intouchables', 37);
insert into Article values(0000005, to_date('27/06/14', 'DD/MM/YY'), 'Mommy: quel beau film', 98);
insert into Article values(0000006, to_date('24/03/13', 'DD/MM/YY'), 'Du grand Tarantino!', 90);
insert into Article values(0000007, to_date('21/09/14', 'DD/MM/YY'), 'L''histoire de la Deuxième Guerre mondiale est un thème abusé au grand écran, mais ce film est un des rares a capté et a canalisé toutes les émotions pour les transmettre au téléspectateur.', 89);
insert into Article values(0000008, to_date('19/01/15', 'DD/MM/YY'), 'Un film à éviter', 13);
insert into Article values(0000009, to_date('01/11/12', 'DD/MM/YY'), 'J''ai perdu 1h45 de ma vie', 01);
insert into Article values(0000010, to_date('07/11/12', 'DD/MM/YY'), 'Honnête performance de l''acteur principal. À considérer dans la course aux Oscars', 88);

---insert into AProposDe values(noArticle,noVideo);
insert into AProposDe values(0000001, 310007);
insert into AProposDe values(0000001, 310003);
insert into AProposDe values(0000002, 300001);
insert into AProposDe values(0000003, 300007);
insert into AProposDe values(0000004, 310010);
insert into AProposDe values(0000005, 310009);
insert into AProposDe values(0000006, 310003);
insert into AProposDe values(0000006, 310006);
insert into AProposDe values(0000007, 310008);
...
insert into Compte values('s.trottier', 'abc1234', '47 de la Brunante', 5141234567, to_date('06/03/10', 'DD/MM/YY'), 10000001);
insert into Compte values('TheBest13', 'TheBestPassword', '50 rue du Meilleur', 5149305678, to_date('10/09/11', 'DD/MM/YY'), 10000002);
insert into Compte values('aerodynamic22', 'daftPunk', '1336 Sherbrooke Est', 5148394068, to_date('05/02/07', 'DD/MM/YY'), 10000003);
insert into Compte values('account1543', 'pasword1234', '4567 boulevard René-Lévesque', 4384409601, to_date('25/08/00', 'DD/MM/YY'), 10000004);
insert into Compte values('private1', 'sup!yo', '732 Ste-Catherine Ouest', 5142451970, to_date('21/11/07', 'DD/MM/YY'), 10000005);
insert into Compte values('emile222', 'tyran0s0re', '43 avenue McNider', 5140954031, to_date('16/03/98', 'DD/MM/YY'), 10000006);
insert into Compte values('djbebe', '12s3df4', '37 rue Nelson', 5148499506, to_date('27/04/03', 'DD/MM/YY'), 10000007);
insert into Compte values('arnaudtse', 'thisismypassword', '97 rue Hutchison', 5149085482, to_date('12/05/95', 'DD/MM/YY'), 10000008);
insert into Compte values('internaute101', 'fckpasswords', '237 avenue Mont-Royal Est', 5142238955, to_date('14/05/98', 'DD/MM/YY'), 10000009);
insert into Compte values('argamedon_jellybean', 'i6g8f5bb3', '239 avenue Mont-Royal Est', 5146582009, to_date('12/09/01', 'DD/MM/YY'), 10000010);

---insert into Loue values('nomUtili', 'chemin', dateLocation, heureLocation 'xx:xx', xxx.xx prix);
insert into Loue values('s.trottier', '\\server0x5f9\main\save\very_bad_trip1', to_date('06/03/14', 'DD/MM/YY'), '10:06', 1.99);
